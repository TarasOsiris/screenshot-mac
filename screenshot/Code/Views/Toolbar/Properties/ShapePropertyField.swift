...
struct ShapePropertyField: View {
    ...
    /// `layout.fieldBezelInset`): the composites around these fields put a preset chevron and a
    /// unit label in the same `HStack`, and neither is what the language overrides.
